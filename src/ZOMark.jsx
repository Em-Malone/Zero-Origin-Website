...
const ZO_B_PATH =
  'M889.08,544.45c0-51.27,41.56-92.83,92.83-92.83l57.95.3h0l-231.33,231.89,174.17-1.38c76.91,0,139.25-62.15,139.25-138.81v-92l-47.21,47.25v45.58c0,51.27-41.56,92.83-92.83,92.83h-59.8l232.44-233.51-171.85.72v.31c-76.91,0-139.25,62.15-139.25,138.81l-1.97,93.66,47.6-48.36.1-48.79';

export function ZOMark({ size = 64, gap = 7, color = 'currentColor', variant = 'a' }) {
  // Hooks must run unconditionally, so call useId before the variant 'b' return.
  ...
  if (variant === 'b') {
    return (
      <svg
        width={size}
        height={size}
        viewBox="808 403 346 280"
        style={{ color, display: 'block' }}
        aria-label="Zero Origin"
        role="img"
      >
